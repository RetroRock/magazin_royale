...
def like_video(youtube, args):
    youtube.videos().rate(id=args.videoId, rating=args.rating).execute()


if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument("--videoId", default="OE63BYWdqC4", help="ID of video to like.")
    parser.add_argument(
        "--rating",
        default="like",
        choices=RATINGS,
    ...
    try:
        ...
        print(
            "The %s rating has been added for video ID %s."
